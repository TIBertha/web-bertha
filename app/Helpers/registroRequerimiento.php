...
function formatDataRegistroRequerimiento($data, $placeholder, $sueldoActividad, $lang = 'es'){
    ...
    if($data){
        ...
        $result = [
            ...
            'numeroMascotas'          => convertToFormatSelectRegistroRequerimiento($data->numero_mascotas),
            'tieneTrabajadoraExtra'   => convertToFormatSelectRegistroRequerimiento($data->tiene_trabajadora_extra, 'boolean', 54, $lang),
            'detalleMascotas'         => $data->detalle_mascotas,
            'detalleTrabajadoraExtra' => $data->detalle_trabajadora_extra,
