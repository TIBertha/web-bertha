...
@section('seo')
    ...
    <meta property="og:url" content="{{ route('condiciones', ['lang' => $lang, 'country' => $country]) }}" />
    <meta property="og:image" content="{{ asset('img/og.png') }}" />
@endsection

@section('content')
    <div id="terminos-condiciones" data-url="{{ url('/') }}" data-country="{{$country}}" data-lang="{{$lang}}"></div>
@endsection
